...
<body>
    <div class="web">
        ...
        <div class="webinfo">
            ...
            <form action="fecha.php" method="post" class="menu">
                <input type="submit" class="btn_menu" name="btnpad" value="Reserva de cancha de paddle">
                <input type="submit" class="btn_menu" name="btnten" value="Reserva de cancha de tenis">
                <input type="submit" class="btn_menu" name="btnsal" value="Reserva de salones y/o quinchos">
                <input type="submit" class="btn_menu" name="btngim" value="Reserva de gimnasio">
                <input type="submit" class="btn_menu" name="btngolf" value="Reserva de golf">
                <input type="submit" class="btn_menu" name="btngolfd"  value="Reserva de práctica de golf">
            </form>
        </div>
